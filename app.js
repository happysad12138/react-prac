...
//统一跨域配置
app.use(cors({
  "origin": ["http://127.0.0.1:8054","http://localhost:5000","http://localhost:8080","http://localhost:8087"],  //允许所有前端域名
...
app.use('/api/swiper',require('./routes/api/swiper'))
...
app.use(function(err, req, res, next) {
  ...
  if(req.url.indexOf('/api') !== -1){
    res.send({error:1,msg:'错误的接口和请求方式111111111111111'})
